...
> Click :star:if you like the project. Pull Request are highly appreciated. Follow me (https://x.com/mahesh_lorenz) for technical updates.
...
2. **ls**: The `ls` command is used to list files or directories. It also accepts some flags or options that changes how files or directories are listed in your terminal.
    ...
    ```bash
     ...
     //Home directory
     $ ls ~
     Desktop    Downloads  Pictures  Mahesh    test   test.txt
